...
private final List<Namespace> namespaces = List.of(
    ...
    public Optional<String> getPublicationDate() {
        return getOptionalText("/cmd1:CMD/cmd1:Components/cmdp:CollectionProfile/cmdp:GeneralInfo/cmdp:PublicationDate|/cmd1:CMD/cmd1:Components/cmdp:CollectionProfile/cmdp:GeneralInfo/cmdp:LastUpdate");
    }
